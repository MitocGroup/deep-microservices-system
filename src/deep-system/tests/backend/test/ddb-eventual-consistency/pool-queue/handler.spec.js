...
import Handler from '../../../../../backend/src/ddb-eventual-consistency/pool-queue/Handler';
...
suite('Handlers', () => {
  ...
  test('Class Handler exists in deep-system-ddb-eventual-consistency-pool-queue module', () => {
